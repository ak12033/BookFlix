...
const HeroSection = () => {
    ...
    return (
        ...
        bg-[url("/backgroundImage.png")] bg-cover bg-center h-screen'>
            ...
            <h1 className='text-5xl md:text-[70px] md:leading-18 font-semibold max-w-110'>Guardians 
            <br />of the Galaxy</h1>
            ...
            wheels and consume each other to survive ,two people meet in London and try to stop a 
            conspiracy.</p>
